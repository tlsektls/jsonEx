    ...
    success : function(data){
      if(data.length> 0) {
        for(let i in data) {
          ...
          $(".book2 .box_bg").eq(i).append("<img src="+ data[i].img + "alt=" + data[i].alt + ">");  
          $(".book2 .b_txt").eq(i).append("<h4>" + data[i].subject + "</h4>"); 
          $(".book2 .b_txt").eq(i).append("<p>" + data[i].author + "</p>"); 
          $(".book2 .b_txt").eq(i).append("<p>" + data[i].price + "</p>"); 
