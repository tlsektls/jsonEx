    ...
    success : function(data){
      if(data.length> 0) {
        for(let i in data) {
          ...
          $(".book3").eq(i).append("<img src='"+ data[i].img + "' alt='" + data[i].alt + "'>");
          $(".book3 .b_txt h4").eq(i).append(data[i].subject); 
          $(".book3 .b_txt .auther").eq(i).append(data[i].author); 
          $(".book3 .b_txt .price").eq(i).append(data[i].price);
        }

          $(".book4").eq(i).append("<img src='"+ data[i].img + "' alt='" + data[i].alt + "'>");
          $(".book4 .b_txt h4").eq(i).append(data[i].subject); 
          $(".book4 .b_txt .auther").eq(i).append(data[i].author); 
          $(".book4 .b_txt .price").eq(i).append(data[i].price);
        }
      }
    }
  });
